...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      isRecordingActiveEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isRecordingActive',
        value: value,
      ));
    });
  }
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByAudioGainDbDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByGeminiModelDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByIsRecordingActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRecordingActive', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy>
      sortByIsRecordingActiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isRecordingActive', Sort.desc);
    });
  }
...
extension AppSettingsQuerySortThenBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByGeminiModel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'geminiModel', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByGeminiModelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'geminiModel', Sort.desc);
    });
  }
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct>
      distinctByIsRecordingActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isRecordingActive');
    });
  }
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, String, QQueryOperations> geminiModelProperty() {
    return QueryBuilder.apply(this, (query) {
